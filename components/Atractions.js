        ...
        <div id="atractions" class="container-fluid mb-5">
            <div className='row'>
                <div className='col-md-12'>
                        ...
                        <p className='text-white'>We’ve designed FloraBangla Flower Park to be a verdant treasure trove<br/> of experiences that capture the imagination, thanks to the<br/> breathtaking landscaping and a range of experiences you can share with friends and family.</p>
                        </div>
